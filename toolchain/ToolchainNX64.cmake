if (DEFINED ENV{BLITZ_CLANG})
    ...
    set(BLITZ_CLANG "${CMAKE_CURRENT_LIST_DIR}/clang-4.0.1")
endif()
...
if (DEFINED BLITZ_LINKER)
    message(STATUS "Using custom linker: ${BLITZ_LINKER}")
    add_link_options(-fuse-ld=${BLITZ_LINKER})
else()
